...
[
  {
    ...
    "type": "person",
    "affiliation": "test project workspace",
    "role": "Maintains the test project folder model and its authoring conventions. Reviews structural changes to keep the context bank queryable, consistent, and traceable across updates.",
