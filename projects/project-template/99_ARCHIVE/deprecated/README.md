...
Artifacts specifically related to Deprecated.
...
- Review adjacent folders when a change affects related material: `99_ARCHIVE/snapshots`, `99_ARCHIVE/obsolete_decisions`, `99_ARCHIVE/retired_requirements`, `99_ARCHIVE/legacy_tests`.
