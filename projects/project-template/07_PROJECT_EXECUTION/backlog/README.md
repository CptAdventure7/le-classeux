...
Artifacts specifically related to Backlog.
...
- Review adjacent folders when a change affects related material: `07_PROJECT_EXECUTION/roadmap`, `07_PROJECT_EXECUTION/work_packages`, `07_PROJECT_EXECUTION/issues`, `07_PROJECT_EXECUTION/milestones`.
