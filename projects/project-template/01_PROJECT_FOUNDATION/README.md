...
Artifacts specifically related to 01 Project Foundation.
...
- Review adjacent folders when a change affects related material: `00_GOVERNANCE`, `02_SYSTEM_DEFINITION`, `03_REQUIREMENTS`.
