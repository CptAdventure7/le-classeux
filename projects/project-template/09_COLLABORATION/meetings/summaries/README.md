...
Cleaned summaries with decisions, actions, and traceable follow-up links.
...
- Review adjacent folders when a change affects related material: `09_COLLABORATION/meetings/raw_notes`.
