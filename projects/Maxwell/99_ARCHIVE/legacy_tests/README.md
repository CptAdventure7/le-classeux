...
Artifacts specifically related to Legacy Tests.
...
- Review adjacent folders when a change affects related material: `99_ARCHIVE/snapshots`, `99_ARCHIVE/deprecated`, `99_ARCHIVE/obsolete_decisions`, `99_ARCHIVE/retired_requirements`.
