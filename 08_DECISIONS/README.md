...
Artifacts specifically related to 08 Decisions.
...
- Review adjacent folders when a change affects related material: `00_GOVERNANCE`, `03_REQUIREMENTS`, `04_DESIGN_AND_IMPLEMENTATION`, `07_PROJECT_EXECUTION`.
