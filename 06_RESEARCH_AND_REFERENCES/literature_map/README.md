...
Artifacts specifically related to Literature Map.
...
- Review adjacent folders when a change affects related material: `06_RESEARCH_AND_REFERENCES/papers`, `06_RESEARCH_AND_REFERENCES/standards`, `06_RESEARCH_AND_REFERENCES/patents`.
