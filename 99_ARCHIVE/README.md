...
Historical material that should remain discoverable but should not drive active project work.
...
- Review adjacent folders when a change affects related material: `00_GOVERNANCE`, `08_DECISIONS`, `11_OPERATIONS_AND_HANDOFF`.
