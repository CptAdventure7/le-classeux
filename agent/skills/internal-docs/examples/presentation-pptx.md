...
Use `FOR-399-218.pptx` as the visual style reference for:
- theme and palette
- slide composition
- typography
...
- Never modify `FOR-399-218.pptx` in place.
...
2. Inspect `FOR-399-218.pptx` for style cues before building.
...
- Editing the file in `FOR-399-218.pptx`
