...
- You don't need to extract information about Information tab
- Do not modify cells with formula. 
- Generally, the risk in here should be linked to project, not specific product risk or failure mode. Information below describe types. 
- Place the extracted jsonl files in a doc/project_risks folder. 
