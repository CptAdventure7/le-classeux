...
User-facing needs, jobs-to-be-done, and externally visible acceptance statements.
...
- Review adjacent folders when a change affects related material: `03_REQUIREMENTS/system_requirements`, `03_REQUIREMENTS/subsystem_requirements`.
