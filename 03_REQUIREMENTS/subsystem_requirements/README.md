...
Subsystem-level requirement sets grouped by technical ownership boundaries.
...
- Review adjacent folders when a change affects related material: `03_REQUIREMENTS/user_requirements`, `03_REQUIREMENTS/system_requirements`.
...
- Use IDs with the `PRJ-SUBREQ-` prefix in this folder.
