...
Unedited capture from meetings. Preserve source fidelity and timestamp notes where possible.
...
- Review adjacent folders when a change affects related material: `09_COLLABORATION/meetings/summaries`.
